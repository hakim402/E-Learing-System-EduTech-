...
if(isset($_REQUEST['submitFeedbackBtn'])){
    if(($_REQUEST['f_content'] == "")){
        ...
        if($conn->query($sql) == TRUE){
            $passmsg = '<div class="alert alert-success col-sm-6 ml-5 mt-2" rol="alert">Submitted Successfully</div>';
        } else {
            $passmsg = '<div class="alert alert-danger col-sm-6 ml-5 mt-2" rol="alert">Unable to Submit</div>';
        }
    }
}
?>
...
<div class="col-sm-6 mt-5">
    <form class="mx-5" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="f_content" name="f_content" row=2> 
            </textarea>
        </div> <br>
